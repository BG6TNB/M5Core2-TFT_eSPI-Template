...
void setup(void)
{
  Axp.begin(); // Enable the PMIC to power the LCD screen.
  Axp.SetLcdVoltage(2700); // The LCD screen backlight is controlled by the AXP192 and can be adjusted from 2.5-3.3v. It is safe to set the backlight voltage at 2.8v and below. Setting the voltage to 3.3v activates the maximum brightness of the LCD screen, but this will cause the screen to heat up and the screen life will be reduced.
